    ...
    var createContainer = function(w, h, el) {
        ...
        process = function(el) {
            var url, con, c, w, h, duration, play, gif, playing = false,
                cc, isC, durationTimeout, mp4Url, webmUrl;
            url = el[ga]('data-gifffer');
            mp4Url = el[ga]('data-video-mp4');
            webmUrl = el[ga]('data-video-webm');
            ...
            el.onload = function() {
                if (isC) {
                    ...
                    if(w > el.parentElement.clientWidth) {
                    ...
                    con.addEventListener('click', function() {
                        ...
                        if (!playing) {
                            playing = true;
                            if(mp4Url) {
                                gif = d.createElement('VIDEO');
                            } else {
                                gif = d.createElement('IMG');
                            }
                            gif[sa]('controls', true);
                            gif[sa]('autoplay', true);
                            ...
                            setTimeout(function() {
                                if(mp4Url) {
                                    gif.innerHTML = '<source src="' + mp4Url + '" type="video/mp4">';

                                    if(webmUrl) {
                                        gif.innerHTML += '<source src="' + webmUrl + '" type="video/webm">'
                                    }
                                } else {
                                    gif.src = url;
                                }
